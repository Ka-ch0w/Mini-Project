...
class Dinosaur:
    ...
    def update(self, userInput):
        ...
        if userInput[pygame.K_UP] and not self.dino_jump:
            ...
            self.dino_run = False
            self.dino_jump = True
            mixer.music.load('JumpSound.mp3')
            mixer.music.play()
...
def main():
    global game_speed, x_pos_bg, y_pos_bg, points, obstacles, HighScore, font, player
    run = True
    ...
    while run:
        ...
        for obstacle in obstacles:
            ...
            if player.dino_rect.colliderect(obstacle.rect):
                ...
                mixer.music.load('DeathSound.mp3')
                mixer.music.play()
...
def menu(death_count):
    ...
    mixer.music.load('gamesound.mp3')
